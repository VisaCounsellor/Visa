...
<head>
    <title>Vagabond a Travel Category Flat Bootstrap Responsive website Template | Home :: w3layouts</title>
		...
		<div class="container py-md-4 mt-md-3">
			<div class="row footer-top-w3layouts-agile py-5">
				...
				<div class="col-md-4 footer-grid">
					...
					<div class="phone">
						<h4>Phone :</h4>
						<p>Phone : +91 78141-56204</p>
						<p>Email : <a href="mailto:info@example.com">dynamicmedia17@gmail.com</a></p>
					</div>
				</div>
				</div>
				<div class="col-md-4 footer-grid">
	...
	<div class="copyright py-3">
		<div class="container">
			...
			<div class="copyrightbottom">
				<p>© 2021 Vagabond. All Rights Reserved | Design by
